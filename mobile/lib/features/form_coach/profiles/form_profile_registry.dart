import 'package:elforma/features/form_coach/profiles/chain_tracking_profiles.dart';
...
class FormProfileRegistry {
  ...
  static FormProfile? lookup({
    ...
    // Specific body chains take precedence over broad catalog aliases.
    for (final profile in chainTrackingProfiles) {
      if (profile.matchKeywords
          .any((word) => haystack.contains(normalize(word)))) return profile;
    }
    FormProfile? best;
    int bestScore = 0;
