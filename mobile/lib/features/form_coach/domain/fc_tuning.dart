...
class FcTuning {
  ...
  // Slightly more responsive than the original conservative tuning. Detection
  // thresholds stay unchanged; only visual phase lag is reduced.
  static const double smoothMinCutoff = 1.6;
  static const double smoothBeta = 0.12;
  static const double smoothDerivativeCutoff = 1.2;
  static const double visibilitySmoothingAlpha = 0.45;
  // The overlay can be more responsive than the validation stream. Validation
  // keeps the conservative filter; the visual stream uses these faster values.
  static const double visualSmoothMinCutoff = 2.6;
  static const double visualSmoothBeta = 0.22;
  static const double visualSmoothDerivativeCutoff = 1.6;
  static const double landmarkSoftFloor = 0.35;
  ...
  // --- tempo
  // A full ROM + return-to-anchor is already a strong anti-noise gate. Keep a
  // short floor for genuinely fast reps instead of forcing a 550ms pause.
  static const int hardMinRepMs = 450;
