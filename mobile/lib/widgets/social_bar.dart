...
class _Social {
  ...
  final String asset;
  final Color color;
  const _Social(this.key, this.label, this.asset, this.color);
}
...
class SocialBar extends StatelessWidget {
  ...
  static const List<_Social> _items = [
    _Social('facebook', 'فيسبوك', 'assets/social/facebook.svg', Color(0xFF1877F2)),
    _Social('instagram', 'إنستجرام', 'assets/social/instagram.svg', Color(0xFFE1306C)),
    _Social('tiktok', 'تيك توك', 'assets/social/tiktok.svg', Color(0xFF25F4EE)),
    _Social('twitter', 'إكس', 'assets/social/twitter.svg', Color(0xFF1DA1F2)),
  ];
          ...
          child: InkWell(
            ...
            child: Ink(
              ...
              decoration: FormaDecoration(
                ...
                border: Border.all(
                  color: s.color.withValues(alpha: .55),
                  width: 1.4,
                ),
                boxShadow: [
                  BoxShadow(
