...
class _SplashScreenState extends State<SplashScreen>
  ...
  Future<void> _boot() async {
    ...
    try {
      ...
      // it never stretches or restarts the 3.45-second animation timeline.
      ...
      // The introductory slides were retired; profile setup is unchanged.
      if (user == null) {
        Navigator.of(context)
            .pushReplacement(_brandFadeRoute(const AuthScreen()));
      } else {
        Navigator.of(
          context,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: AnimatedBuilder(
        animation: _c,
        builder: (context, _) =>
            BrandIntroScene(progress: _c.value, waiting: _introFinished),
      ),
    );
  }
}
