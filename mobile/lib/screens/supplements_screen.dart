...
class _SupplementsScreenState extends State<SupplementsScreen> {
      ...
      builder: (dialogContext) => StatefulBuilder(
        builder: (innerContext, setLocal) => AlertDialog(
          ...
          content: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Row(children: [
              const FormaIcon(Icons.schedule_rounded,
      ...
      children: [
        Container(
          ...
          child: const Column(
            ...
            children: [
              Row(children: [
                FormaIcon(Icons.shield_rounded, color: AppColors.wo, size: 20),
                SizedBox(width: 8),
                Expanded(
  ...
  List<Widget> _groupedRows(List<Supp> list) {
    Widget header(String text, IconData icon, Color color) => Padding(
          ...
          child: Row(children: [
            FormaIcon(icon, size: 17, color: color),
              ...
              children: [
                Row(children: [
                  ...
                  IconButton(
                    ...
                    icon: const FormaIcon(Icons.error_outline_rounded,
                  ...
                  if (supp.custom)
                    IconButton(
                      ...
                      constraints:
                          const BoxConstraints(minWidth: 30, minHeight: 30),
                      icon: const FormaIcon(Icons.delete_outline_rounded,
