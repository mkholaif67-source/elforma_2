...
import 'package:elforma/screens/custom_reminders_screen.dart';
import 'package:elforma/screens/supplements_screen.dart';
...
class _ReminderSettingsScreenState extends State<ReminderSettingsScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          ...List.generate(waterTimes.length, (i) {
            ...
            return Row(children: [
              const FormaIcon(Icons.water_drop_rounded,
              ...
              IconButton(
                ...
                icon: const FormaIcon(Icons.close_rounded, size: 17),
        ...
        children: [
          ...
          if (days.isEmpty)
            ...
            ...List.generate(days.length, (i) {
              ...
              return Row(children: [
                FormaIcon(Icons.event_rounded, size: 15, color: color),
                const SizedBox(width: 8),
                Expanded(
        ...
        children: [
          ...
          if (planMeals.isEmpty)
            ...
            ...List.generate(planMeals.length, (i) {
              ...
              return Row(children: [
                const FormaIcon(Icons.restaurant_rounded, size: 15, color: AppColors.nu),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(
                    m['cals'] == null
  ...
  Widget _masterCard() => Container(
        ...
        child: Column(children: [
          ...
          if (master) ...[
            ...
            Row(children: [
              const FormaIcon(Icons.bedtime_rounded,
    ...
    return Scaffold(
      ...
      body: loading
        ...
        padding: const EdgeInsets.all(18), children: [
          ...
          _reminder(Icons.monitor_weight_outlined, 'الوزن والقياسات', 'كل سبت', weight, const Color(0xFF996214),
  ...
  Widget _navTile(IconData icon, String title, String subtitle, Color color, Widget target) => InkWell(
        ...
        child: Container(
          ...
          child: Row(children: [
            Container(
              width: 40, height: 40,
              decoration: FormaDecoration(color: color.withValues(alpha: .13), borderRadius: BorderRadius.circular(12)),
              child: FormaIcon(icon, color: color, size: 20),
            ),
            const SizedBox(width: 11),
  ...
  Widget _syncCard() => Container(
        ...
        child: Row(children: [
          Container(width: 44, height: 44, decoration: FormaDecoration(color: AppColors.nu.withValues(alpha: .12), borderRadius: BorderRadius.circular(13)),
              child: FormaIcon(pending == 0 ? Icons.cloud_done_outlined : Icons.cloud_upload_outlined, color: AppColors.nu)),
          const SizedBox(width: 11),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (pending > 0) IconButton(tooltip: 'مزامنة البيانات المعلقة', onPressed: syncing ? null : _sync,
              icon: syncing ? const SizedBox(width: 18, height: 18, child: FormaLoader(strokeWidth: 2)) : const FormaIcon(Icons.sync_rounded, color: AppColors.nu)),
        ]),
      );
  ...
  Widget _reminder(IconData icon, String title, String subtitle, bool enabled, Color color,
      ValueChanged<bool> onChanged, VoidCallback? onTime, String? time) => Container(
        ...
        decoration: FormaDecoration(color: AppColors.card, borderRadius: BorderRadius.circular(15), border: Border.all(color: enabled ? color.withValues(alpha: .42) : AppColors.line)),
        child: Row(children: [
          FormaIcon(icon, color: color),
          const SizedBox(width: 10),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
