  ...
  Future<void> _load() async {
    ...
    setState(() {
      ...
      if (r.ok) {
        ...
        _error = r.friendlyError('تعذر تحميل الباقات');
      }
    });
  }
  ...
  Widget _errorView() => Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const FormaIcon(Icons.wifi_off, color: AppColors.muted, size: 40),
  ...
  Widget _planCard(Map<String, dynamic> p) {
    ...
    return InkWell(
      ...
      child: AnimatedContainer(
        ...
        child: Row(
          children: [
            FormaIcon(sel ? Icons.check_circle : Icons.circle_outlined,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          const FormaIcon(Icons.arrow_drop_down_rounded, color: AppColors.muted),
        ]),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            tooltip: 'نسخ',
            icon: const FormaIcon(Icons.copy, color: AppColors.nu2, size: 20),
            onPressed: () {
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: const FormaIcon(Icons.check_rounded,
        ...
        if (wa.isNotEmpty) ...[
          ...
          Container(
            ...
            child: Row(children: [
              const FormaIcon(Icons.chat, color: AppColors.nu2, size: 20),
              const SizedBox(width: 10),
              ...
              IconButton(
                ...
                icon: const FormaIcon(Icons.copy, size: 18, color: AppColors.nu2),
                onPressed: () {
