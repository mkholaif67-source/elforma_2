      ...
      builder:(ctx)=>SafeArea(child:SizedBox(height:MediaQuery.sizeOf(ctx).height*.75,
        child:ListView(children:[
          ...
          for(final label in _fields.keys) ListTile(title:Text(label),
            trailing:const FormaIcon(Icons.edit_outlined),onTap:()=>Navigator.pop(ctx,label)),
        ]))));
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            tooltip: 'رجوع',
            icon: const FormaIcon(Icons.arrow_back_rounded),
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            width: 48, height: 48,
            decoration: const FormaDecoration(shape: BoxShape.circle,
              gradient: LinearGradient(colors: [AppColors.nu, AppColors.nu2])),
            child: const FormaIcon(Icons.verified_rounded, color: Color(0xFFFFFFFF), size: 28),
          ),
        ...
        if (bmi != null) ...[
          ...
          Container(
            ...
            decoration: FormaDecoration(color: AppColors.bg.withValues(alpha: .5),
          ...
          children: [
            Row(children: [
              Container(
                width: 32,
                height: 32,
                decoration: FormaDecoration(color: color.withValues(alpha: .16), borderRadius: BorderRadius.circular(10)),
                child: FormaIcon(icon, color: color, size: 18),
              ),
  ...
  Widget _row(String label, String value) => Semantics(
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: FormaDecoration(border: Border(
            ...
            child: Row(children: [
              ...
              Expanded(flex: 5, child: Row(children: [
                ...
                Container(width: 32, height: 32,
                  decoration: FormaDecoration(color: AppColors.bg,
                    borderRadius: BorderRadius.circular(8)),
                  child: const FormaIcon(Icons.edit_outlined, size: 17, color: AppColors.nu2)),
              ])),
            ]),
          ),
        ),
