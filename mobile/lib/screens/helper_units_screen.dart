...
const Map<String, UnitStyle> kUnitStyles = {
  ...
  'kegel': UnitStyle(Icons.favorite_rounded, Color(0xFF996214),
...
class _HelperUnitsHubState extends State<HelperUnitsHub> {
  ...
  Future<void> _load() async {
    ...
    if (!response.ok) {
      setState(() {
        loading = false;
        error = response.friendlyError(
            '\u0645\u0642\u062f\u0631\u0646\u0627\u0634 \u0646\u062d\u0645\u0644 \u0627\u0644\u062a\u0645\u0627\u0631\u064a\u0646 \u0627\u0644\u0645\u0643\u0645\u0644\u0629 \u062f\u0644\u0648\u0642\u062a\u064a');
      });
      return;
    }
  ...
  Future<void> _toggle(HelperUnit unit, bool value) async {
    ...
    if (response.ok) {
      await ProfileStore.I.apply(profile);
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('مقدرناش نحفظ دلوقتي جرب تاني')));
    }
  }
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child:
                          FormaIcon(style.icon, color: style.color, size: 21),
                    ),
                    const Spacer(),
                    Transform.scale(
                      scale: 0.78,
      ...
      body: ListView(
        ...
        children: [
          Container(
            ...
            child: Row(children: [
              FormaIcon(style.icon, color: style.color, size: 26),
                ...
                child: AspectRatio(
                  ...
                  child: id.isEmpty
                      ...
                      : Stack(fit: StackFit.expand, children: [
                          ...
                          const Center(
                            child: FormaIcon(Icons.play_circle_fill,
...
class _UnitRunnerScreenState extends State<UnitRunnerScreen> {
  ...
  void _finish() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('خلصت ${widget.unit.label} تسلم إيدك ')));
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (exercises.isEmpty) {
      return const Scaffold(
        ...
        body: Center(
            child:
                Text('مافيش تمارين', style: TextStyle(color: AppColors.muted))),
      );
    }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Semantics(
            button: exercise.videoId.isNotEmpty,
            enabled: exercise.videoId.isNotEmpty,
            label: exercise.videoId.isEmpty
                ? 'لا يوجد فيديو لتمرين ${exercise.name}'
                : 'تشغيل فيديو تمرين ${exercise.name}',
            child: Material(
              color: Colors.transparent,
              borderRadius: BorderRadius.circular(18),
              clipBehavior: Clip.antiAlias,
              child: InkWell(
                onTap: exercise.videoId.isEmpty
                    ? null
                    : () => _openVideo(exercise.videoId),
                child: exercise.videoId.isEmpty
                    ? Container(
                        height: 190,
                        color: AppColors.card,
                        child:
                            FormaIcon(style.icon, color: style.color, size: 46))
            ...
            if (index > 0) ...[
              SizedBox(
                ...
                child: OutlinedButton(
                  ...
                  child: const FormaIcon(Icons.chevron_right_rounded,
                      color: AppColors.muted),
                ),
              ),
  ...
  Widget _timerCard(UnitStyle style) => Container(
        ...
        child: Row(children: [
          FormaIcon(Icons.timer_outlined, color: style.color, size: 22),
          ...
          IconButton(
            ...
            icon:
                const FormaIcon(Icons.refresh_rounded, color: AppColors.muted),
          ),
          SizedBox(
            height: 40,
            child: ElevatedButton(
