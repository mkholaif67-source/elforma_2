...
class _HelperUnitsHubState extends State<HelperUnitsHub> {
  ...
  Widget _errorView() => ListView(
        ...
        children: [
          const FormaIcon(Icons.cloud_off_rounded, color: AppColors.muted, size: 44),
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: FormaIcon(style.icon, color: style.color, size: 21),
                    ),
                    const Spacer(),
                    Transform.scale(
                      scale: 0.78,
              ...
              child: InkWell(
                ...
                child: exercise.videoId.isEmpty
                  ? Container(
                      height: 190,
                      color: AppColors.card,
                      child: FormaIcon(style.icon, color: style.color, size: 46))
  ...
  Widget _timerCard(UnitStyle style) => Container(
        ...
        child: Row(children: [
          ...
          IconButton(
            ...
            icon: const FormaIcon(Icons.refresh_rounded, color: AppColors.muted),
          ),
          SizedBox(
            height: 40,
            child: ElevatedButton(
