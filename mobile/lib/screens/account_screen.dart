...
class _AccountScreenState extends State<AccountScreen> {
  ...
  void _adsChanged(){if(mounted)setState((){});}

  Future<void> _load({bool force = false}) async {
    final generation = ++_loadGeneration;
    if (_user == null) setState(() { _loading = true; _error = null; });
  ...
  Future<void> _openEditAccount() async {
    ...
    if (changed == true) _load(force: true);
  }
  ...
  List<Widget> _announcementCards() {
    final list = AnnouncementStore.I.loaded?AnnouncementStore.I.items:_announcements;
  ...
  Widget _smartCoachTile() {
    return Container(
      ...
      child: SwitchListTile(
        ...
        secondary: const FormaIcon(Icons.auto_awesome_rounded, color: AppColors.nu2),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      ...
                      if (changed == true && mounted) _load(force: true);
                    },
