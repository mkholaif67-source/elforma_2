...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Future<void> _logout() async {
    ...
    // إشعار accountChanges بينفذ والـ shell بيعيد بناء التبويبات ويدمّر هذه
    // الشاشة، فأي Navigator.of(context) أو فحص mounted بعد الـ await كان بيلغي
    // الانتقال بهدوء — وده كان سبب إن الخروج ماكانش بيرجع لشاشة الدخول أبدًا.
    ...
    try {
      ...
      // الجلسة اتمسحت محليًا بالفعل وشاشة الدخول هتظهر في كل الأحوال.
    }
