        ...
        child: InkWell(
          ...
          child: Ink(
            ...
            child: Row(mainAxisSize: MainAxisSize.min, children: [
              ExcludeSemantics(
                child: FormaIcon(s['icon'] as IconData, size: 18, color: color),
              ),
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          child: const FormaIcon(Icons.support_agent_rounded, color: AppColors.nu2, size: 28),
        ),
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          child: FormaIcon(icon, color: color, size: 24),
        ),
