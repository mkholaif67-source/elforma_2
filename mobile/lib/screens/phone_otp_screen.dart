...
class _PhoneOtpScreenState extends State<PhoneOtpScreen> {
  ...
  Future<void> _sendOtp() async {
    ...
    if (!mounted) return;
    setState(() { _busy = false; if (!res.ok) _error = res.friendlyError('تعذر إكمال الطلب. حاول مرة أخرى'); });
  }
  ...
  Future<void> _verify() async {
    ...
    if (res.ok) {
      ...
      setState(() => _error = res.friendlyError('كود غلط أو منتهي'));
    }
  }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            FormaIcon(Icons.phone_android_rounded, size: 64, color: AppColors.nu),
            ...
            ElevatedButton(
              ...
              child: _busy
                ? const FormaLoader(color: Colors.white)
