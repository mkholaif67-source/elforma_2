...
class _WorkoutHistoryScreenState extends State<WorkoutHistoryScreen> {
  ...
  Widget _sessionCard(Map<String, dynamic> session) {
    ...
    return Container(
      ...
      decoration: FormaDecoration(color: AppColors.card, borderRadius: BorderRadius.circular(16), border: Border.all(color: AppColors.line)),
      child: ExpansionTile(
        shape: const Border(),
        collapsedShape: const Border(),
        tilePadding: const EdgeInsets.symmetric(horizontal: 14, vertical: 4),
        childrenPadding: const EdgeInsets.fromLTRB(14, 0, 14, 13),
        leading: Container(width: 42, height: 42, decoration: FormaDecoration(color: AppColors.wo.withValues(alpha: .12), borderRadius: BorderRadius.circular(12)),
            child: const FormaIcon(Icons.fitness_center, color: AppColors.wo2, size: 21)),
  ...
  Widget _exerciseSets(String name, List<Map<String, dynamic>> sets) => Padding(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const FormaIcon(Icons.check_circle, color: AppColors.nu, size: 17),
          const SizedBox(width: 7),
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
