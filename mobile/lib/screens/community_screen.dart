  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          ...
          actions: [
            if (!widget.recipes)
              IconButton(
                tooltip: 'تحديات الاصحاب',
                onPressed: () => Navigator.of(context).push(
                  MaterialPageRoute(builder: (_) => const FriendChallengesScreen()),
                ),
                icon: const FormaIcon(Icons.groups_rounded),
              ),
            IconButton(
              tooltip: 'تحديث',
              onPressed: load,
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style:
                          const TextStyle(color: AppColors.muted, height: 1.7),
                    ),
            ...
            IconButton(
              ...
              onPressed: () async {
                final made = await Navigator.of(context).push<bool>(
                  MaterialPageRoute(builder: (_) => FriendChallengeEditor(personal: p)),
                );
                if (made == true && mounted) {
                  await Navigator.of(context).push(
                    MaterialPageRoute(builder: (_) => const FriendChallengesScreen()),
                  );
                }
              },
              icon: const FormaIcon(Icons.group_add_rounded),
            ),
          if (p != null && p['team'] != true)
            IconButton(
                  ...
                  if (p['joined'] == true) ...[
                    ...
                    Wrap(
                      ...
                      children: List.generate((p['duration'] as num).toInt(), (
                        ...
                        return Semantics(
                          label:
                              '$day: ${done ? 'مكتمل' : scheduled ? 'غير مكتمل' : 'راحة'}',
                          child: Container(
                            width: 38,
                            height: 38,
                            alignment: Alignment.center,
          ...
          child: ListView(
            ...
            children: [
              ...
              const Text(
                ...
                style: TextStyle(
                    color: AppColors.muted, height: 1.7, fontSize: 12),
              ),
              if (error != null)
                Padding(
