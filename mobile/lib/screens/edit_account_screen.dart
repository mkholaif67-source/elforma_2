...
import 'package:elforma/screens/change_password_screen.dart';
import 'package:elforma/screens/email_verify_screen.dart';
import 'package:elforma/screens/phone_otp_screen.dart';
...
class _EditAccountScreenState extends State<EditAccountScreen> {
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            Row(
              children: const [
                FormaIcon(Icons.manage_accounts_rounded,
  ...
  Widget _row({
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          FormaIcon(icon, color: AppColors.muted, size: 20),
  ...
  Widget _badge(String text, Color fg, Color bg) => Container(
        ...
        decoration:
            FormaDecoration(color: bg, borderRadius: BorderRadius.circular(6)),
        child: Text(text,
            style: TextStyle(
                ...
                Padding(
                  ...
                  child: TextField(
                    ...
                    decoration: const InputDecoration(
                        prefixIcon: FormaIcon(Icons.search_rounded),
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              IconButton(
                  icon: const FormaIcon(Icons.close_rounded, size: 20),
                    ...
                    _detecting
                        ? const Padding(
                            ...
                            child: SizedBox(
                                width: 12,
                                height: 12,
                                child: FormaLoader(strokeWidth: 2)))
                        : const FormaIcon(Icons.arrow_drop_down_rounded,
                            color: AppColors.muted),
                  ]),
                ),
              ),
