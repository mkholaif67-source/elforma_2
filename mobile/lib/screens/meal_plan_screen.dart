...
class _MealPlanScreenState extends State<MealPlanScreen> {
      ...
      return Semantics(
        ...
        child: OutlinedButton(
          style: OutlinedButton.styleFrom(
            foregroundColor: selected ? const Color(0xFF04231B) : AppColors.text,
    ...
    return Column(crossAxisAlignment:CrossAxisAlignment.stretch,children:[
      ...
      Row(children:[
        Expanded(child:OutlinedButton.icon(
          ...
          icon:Icon(_showFullWeek?Icons.expand_less:Icons.calendar_month_outlined,size:18),
  ...
  Widget _dailySummary() {
    ...
    return Container(
      ...
      child: Column(children: [
        if(_portionNotice!=null)Padding(padding:const EdgeInsets.only(bottom:8),child:Text(_portionNotice!,style:const TextStyle(color:AppColors.muted,fontSize:12))),
