...
class _EmailVerifyScreenState extends State<EmailVerifyScreen> {
  ...
  Future<void> _resend() async {
    ...
    if (!mounted) return;
    setState(() { _busy = false; _sent = res.ok; if (!res.ok) _error = res.friendlyError('تعذر إكمال الطلب. حاول مرة أخرى'); });
  }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            FormaIcon(Icons.mark_email_unread_outlined, size: 72, color: AppColors.nu),
