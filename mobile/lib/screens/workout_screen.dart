...
class _WorkoutScreenState extends State<WorkoutScreen>
  ...
  // [FIX-SILENT-REFRESH] التحديثات الخلفية (تغيّر المخازن، منتصف الليل، رجوع
  ...
  Future<void> _generate({bool loadAlternatives = false, bool silent = false}) async {
    ...
    setState(() {
      ...
      // السبينر الكامل بس لما مفيش جدول ظاهر أصلًا.
    ...
    if(!bootstrap.ok){
      ...
      // بهدوء بدل بانر أحمر بيخوّف المستخدم على لا حاجة.
    ...
    if (locked) {
      ...
      if (!restToday && r['storedOnly'] == true && (exp == 'advanced' || exp == 'intermediate')) {
        children.add(Padding(padding: const EdgeInsets.only(top: 16), child: OutlinedButton.icon(
          ...
          icon: const Icon(Icons.swap_horiz_rounded), label: const Text('تغيير الجدول'))));
      }
    ...
    return Container(
      ...
      child: Column(children: [
        Container(
          ...
          child: const Icon(Icons.verified_rounded, color: AppColors.nu, size: 32),
        ),
        const SizedBox(height: 14),
    ...
    return Column(children: [
        ...
        child: Column(children: [
          Container(
            ...
            child: const Row(mainAxisSize: MainAxisSize.min, children: [
              Icon(Icons.auto_awesome_rounded, color: calm, size: 15),
              SizedBox(width: 7),
      ...
      Container(
        ...
        child: const Column(children: [
          ...
          _RestFocusRow(icon: Icons.water_drop_outlined,
              title: 'مية وأكل ��فاية', value: 'كمل احتياجك'),
          Divider(height: 20, color: AppColors.line),
      ...
      Container(
        ...
        child: const Row(children: [
          Icon(Icons.favorite_rounded, color: AppColors.wo2, size: 20),
          SizedBox(width: 10),
