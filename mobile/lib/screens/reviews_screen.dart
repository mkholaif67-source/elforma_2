...
class _ReviewsScreenState extends State<ReviewsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        onPressed: _openForm,
        icon: const FormaIcon(Icons.rate_review, color: Colors.white),
                ...
                children: [
                  Row(children: [
                    ...
                    if (isCustomer) ...[
                      ...
                      const FormaIcon(Icons.verified,
  ...
  Widget _empty() {
    return Padding(
      ...
      child: Column(
        children: [
          const FormaIcon(Icons.reviews_outlined,
  ...
  Future<void> _submit() async {
    ...
    setState(() {
      ...
      if (r.status == 401) {
        ...
        _error = r.friendlyError('تعذر إرسال التقييم');
      }
    });
  }
