...
def verify(root=ANDROID):
    ...
    assert any(name in kotlin for name in ['io.flutter.embedding.android.FlutterActivity', 'io.flutter.embedding.android.FlutterFragmentActivity']), 'Flutter v2 activity required'
