...
const BREAKFAST = [
  ...
  { id: 'gebna_rods',  nameAr: 'جبنة رودس طبيعي',  cat: 'cheese',        per100: { cal: 280, pro: 18,  carb: 3,   fat: 22 } },
...
const LUNCH_PROTEIN_CHICKEN = [
  ...
  { id: 'kwanes_kbda', nameAr: 'كبد وقوانص فراخ',   cat: 'protein_chicken', per100: { cal: 143, pro: 22, carb: 1, fat: 5 } },
...
const LUNCH_PROTEIN_MEAT = [
  ...
  { id: 'kebda_eskandarani', nameAr: 'كبدة إسكندراني', cat: 'protein_meat', per100: { cal: 191, pro: 26, carb: 5, fat: 7 } },
];
const LUNCH_FISH = [
  ...
  { id: 'tuna',        nameAr: 'تونة',          cat: 'fish', per100: { cal: 116, pro: 26, carb: 0, fat: 1 }, maxGramsPerDay: 300 },
];
const LUNCH_COOKED_VEG_SOUP = [
  ...
  { id: 'bamia',         nameAr: 'بامية مطبوخة',   cat: 'cooked_veg',    per100: { cal: 33,  pro: 2,  carb: 7,  fat: 0.2 } },
  { id: 'sabanikh',      nameAr: 'سبانخ مطبوخة',   cat: 'cooked_veg',    per100: { cal: 23,  pro: 2.9, carb: 3.6, fat: 0.4 } },
...
const CARBS = [
  ...
  { id: 'rice_basmati',nameAr: 'ارز بسمتي', cat: 'carb', per100: { cal: 130, pro: 2.7, carb: 28, fat: 0.3 } },
...
const SALAD_ITEMS = [
  { id: 'tmatm',      nameAr: 'طماطم',       cat: 'salad_veg', per100: { cal: 18, pro: 0.9, carb: 3.9, fat: 0.2 } },
  { id: 'khyar',    nameAr: 'خيار',        cat: 'salad_veg', per100: { cal: 15, pro: 0.7, carb: 3.6, fat: 0.1 } },
  { id: 'flfl',nameAr: 'فلفل أخضر',   cat: 'salad_veg', per100: { cal: 20, pro: 0.9, carb: 4.6, fat: 0.2 } },
  { id: 'jzr',      nameAr: 'جزر',         cat: 'salad_veg', per100: { cal: 41, pro: 0.9, carb: 10,  fat: 0.2 } },
  { id: 'khs',     nameAr: 'خس',          cat: 'salad_veg', per100: { cal: 15, pro: 1.4, carb: 2.9, fat: 0.2 } },
];
...
const COMPLEMENTS = [
  ...
  { id: 'oil',    nameAr: 'زيت',   cat: 'fat', per100: { cal: 884, pro: 0, carb: 0, fat: 100 },
    complement: true, gramsMin: 2, gramsMax: 10, linkedTo: ['foul', 'gebna_2rish', 'gebna_rods', 'gebna_beda', 'salad', 'kebda_eskandarani', 'kwanes_kbda'] },
  ...
  { id: 'tahina', nameAr: 'طحينة', cat: 'fat', per100: { cal: 595, pro: 17, carb: 21, fat: 54 },
    complement: true, gramsMin: 20, gramsMax: 50, maxPerWeek: 3,
    linkedTo: ['blty_mashwy', 'makaryl', 'bory', 'sardin', 'kofta_lahma', 'kofta_frakh', 'sadr_frakh'] },
  // زيتون مخلل: مرة واحدة في اليوم وبحد أقصى 4 مرات/أسبوع.
  { id: 'olives', nameAr: 'زيتون مخلل', cat: 'other', per100: { cal: 115, pro: 0.8, carb: 6, fat: 11 },
    complement: true, appetizer: true, gramsMin: 40, gramsMax: 50, maxPerDay: 1, maxPerWeek: 5 },
];

const FRUITS_YEAR_ROUND = ['موز', 'تفاح', 'تمر'];
const FRUITS_SUMMER = ['بطيخ','مانجو','عنب','خوخ','مشمش','برقوق','تين','تين شوكي','شمام','كانتالوب','جوافة','بلح'];
const FRUITS_WINTER = ['برتقال','يوسفي','فراولة','رمان','جوافة','كاكا','كيوي'];
...
const PRE_WORKOUT_ADDONS = [
  ...
  // موسم البطاطا المصرية الأساسي: حصاد أغسطس وطرح ممتد عادة حتى يناير.
  { id: 'sweet_potato', nameAr: 'بطاطا', cat: 'carb', per100: { cal: 86, pro: 1.6, carb: 20, fat: 0.1 }, seasonal: true, seasonMonths: [8,9,10,11,12,1] },
];
const PRE_WORKOUT_MIN_ADDONS = 1;
const PRE_WORKOUT_MAX_ADDONS = 1;
...
const DAILY_LIMITS = {
  tunaMaxGrams: 300,      // تونة ≤ 300 جم/يوم (إجمالي اليوم)
  eggMinGramsWhenUsed: 100,
  eggMaxGrams: 300,
  yogurtMaxGrams: 200,    // زبادي ≤ 200 جم/يوم، ومايتحطش كله في وجبة واحدة
  singleMealShareMax: 0.40, // وجبة رئيسية ≤ 35% من اليوم لو فيه 3 وجبات أو أكثر
...
module.exports = {
  ...
  DAILY_LIMITS,
  FRUITS_YEAR_ROUND, FRUITS_SUMMER, FRUITS_WINTER,
  allItems, byMeal,
};
