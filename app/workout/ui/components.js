...
function buildMuscleMap(){
  ...
  if (typeof PlanValidator !== 'undefined' && PlanValidator.diagnosePlan) {
    try {
      PlanValidator.diagnosePlan(state.plan, { minEx: state.exp === 'advanced' ? (state.gender === 'female' ? 5 : 6) : (state.gender === 'male' ? 5 : (state.exp === 'beginner' ? 4 : 5)) });
...
function buildExercisePlan(){
  ...
  (function enforceMinExercisesAbsolute() {
    ...
    const _absMinEx    = state.exp === 'advanced' ? (state.gender === 'female' ? 5 : 6) : (state.gender === 'male' ? 5 : (_isNotBegAbs ? 5 : 4));
    const _isHome      = !!(state.equip === 'home' || state.equip === 'none');
...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
const VERIFIED_VIDS = {
  // Owner-supplied replacements, 2026-09-07 (no automatic substitutes).
  'K2m0jj6RfYg': true, // Cable Crunch
  'db4_x6rpji8': true, // Cable Woodchop
  '3uj8eL4hwTo': true, // Child's Pose Lower Back
  'g6bFHtU-SPo': true, // Decline Sit-Up
  'Q-HRZLba_20': true, // Hanging Leg Raise
  'vMuOcANVE1o': true, // Thoracic Rotation (CARs)
  // ── CHEST ──
