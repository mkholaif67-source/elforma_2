...
function getSplitSchedule(splitKey,days){
  ...
  if(splitKey==='upper_lower'){
    ...
    //  - ضامة - كما أيام الأرجل (adductors تعمل في ال squat + Romanian patterns)
  ...
  if(splitKey==='anterior_posterior'){
    ...
    //   Anterior (أمامي): كوادز · صدر · كتف أمامي+جانبي · بايسبس · سمانة
    //   Posterior (خلفي): هامستينج · جلوتس · ظهر (لاتس+وسط+سفلي) · كتف خلفي + ترابيس · ترايسبس
    //   [COACH-FIX 2026-09] الترايسبس عضلة خلفية الذراع تشريحيًا → اتنقلت لأيام Posterior
    //
    ...
    //   ترايسبس    : Post A (lateral) + Post B (long) - رأسين مختلفين [COACH-FIX] 
    ...
    const base4=[
      ...
      // ── ANTERIOR A ────────────────────────────────────────────────────
      // السلسلة الأمامية — كوادز Squat + صدر مسطح (محور) + كتف جانبي + كتف أمامي + بايسبس short + سمانة
      // [COACH-FIX] الترايسبس اتنقل لأيام Posterior (عضلة خلفية الذراع)
      {
        name:'Anterior A — كوادز + صدر مسطح + كتف جانبي + كتف أمامي + بايسبس + سمانة',
        muscles:['كوادز','صدر','أكتاف جانبي','أكتاف أمامي','بايسبس','سمانة'],
        groups:[
      ...
      // ──── POSTERIOR A ───────────────────────────────────────────────────
      // السلسلة الخلفية — هامستينج RDL (محور) + جلوتس Hip Hinge + لاتس + ظهر وسط + ظهر سفلي + كتف خلفي + ترابيس + ترايسبس
      {
        name:'Posterior A — هامستينج RDL + جلوتس Hip Hinge + لاتس + ظهر سمك + ظهر سفلي + كتف خلفي + ترابيس + ترايسبس',
        muscles:['هامستينج','جلوتس','ظهر لاتس','ظهر سمك','ظهر سفلي','دلتا خلفي','ترابيس','ترايسبس'],
        groups:[
          ...
          ['triceps','lateral']      // [COACH-FIX] ترايسبس رأس جانبي — عضلة خلفية الذراع، مكانها Posterior
        ],
      ...
      // ── ANTERIOR B ────────────────────────────────────────────────────
      // السلسلة الأمامية — صدر علوي (محور) + كوادز لونج + كتف جانبي+أمامي + بايسبس long + ضامة + سمانة
      // [COACH-FIX] الترايسبس اتنقل لأيام Posterior (عضلة خلفية الذراع)
      {
        name:'Anterior B — صدر علوي + كوادز لونج + كتف جانبي+أمامي + بايسبس long + ضامة + سمانة',
        muscles:['صدر علوي','كوادز','أكتاف','بايسبس','ضامة','سمانة'],
        groups:[
          ['chest','upper'],         // صدر علوي (Incline — محور اليوم)
      ...
      // ── POSTERIOR B ───────────────────────────────────────────────────
      // السلسلة الخلفية — هامستينج Leg Curl + جلوتس Hip Thrust (محور) + لاتس + ظهر وسط + كتف خلفي + ترابيس + ترايسبس + ضامة
      {
        // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
        ...
        // ─────────────────────────────────────────────────────────────────
        name:'Posterior B — هامستينج Curl + جلوتس Hip Thrust + لاتس + ظهر وسط + كتف خلفي + ترابيس + ترايسبس + ضامة',
        muscles:['هامستينج','جلوتس','ظهر لاتس','ظهر وسط','دلتا خلفي','ترابيس','ترايسبس','ضامة'],
        groups:[
          ...
          ['triceps','long'],        // [COACH-FIX] ترايسبس رأس طويل — عضلة خلفية الذراع، مكانها Posterior
