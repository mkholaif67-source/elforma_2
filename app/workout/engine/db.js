...
const GYM_DB = {
  ...
  core:{
    all:[
      {n:'Cable Crunch',                    alt:'Ab Wheel Rollout',             vid:'K2m0jj6RfYg', vidPrevious:['mKp3sLESlhU', 'iRYIqSFN21w'], mu:'بطن علوي وكور',    tier:'S', safe_injuries:['knee','shoulder','wrist'], goal_bonus:['cut','muscle']},
      ...
      {n:'Hanging Leg Raise',               alt:'Cable Crunch',                 vid:'Q-HRZLba_20', vidPrevious:['2HgbXXA-uqE'], mu:'بطن سفلي',         tier:'S', safe_injuries:['back_mild','knee','shoulder_mild'], goal_bonus:['fitness','cut']},
      {n:'Cable Woodchop',                  alt:'Russian Twist',                vid:'db4_x6rpji8', vidPrevious:['yy3TRnJYE08', '8OZImYISmSg'], mu:'بطن جانبي وكور',   tier:'A', safe_injuries:['knee','shoulder_mild','back_mild'], goal_bonus:['fitness','cut']},
      ...
      {n:'Decline Sit-Up',                  alt:'Cable Crunch',                 vid:'g6bFHtU-SPo', vidPrevious:['G2vYhVJq_Nk'], mu:'بطن علوي',         tier:'A', safe_injuries:['knee','shoulder','wrist','elbow'], goal_bonus:['fitness','cut']},
...
const HOME_DB = {
  ...
  core:{
    all:[
      {n:'Hanging Leg Raise (Pull-Up Bar)', alt:'Plank',                        vid:'Q-HRZLba_20', vidPrevious:['2HgbXXA-uqE'], mu:'بطن سفلي',         tier:'S', safe_injuries:['back_mild','knee'],          goal_bonus:['fitness']},
...
const MODULE_DB = {
  ...
  core:[
    // S Tier
    {n:'Cable Crunch',                tier:'S', sets:'3×12-15', desc:'أفضل تمرين للبطن العلوي بحمل خارجي — Progressive Overload ممكن', vid:'K2m0jj6RfYg', vidPrevious:['mKp3sLESlhU', 'iRYIqSFN21w'], equipment:'gym', fatigue:'low', mu:'بطن علوي', category:'core_weighted'},
    {n:'Hanging Leg Raise',           tier:'S', sets:'3×10-12', desc:'أفضل تمرين للبطن السفلي — يشغل Hip Flexors وال Core بالكامل', vid:'Q-HRZLba_20', vidPrevious:['2HgbXXA-uqE'], equipment:'gym_home', fatigue:'low', mu:'بطن سفلي', category:'core_bodyweight'},
    ...
    {n:'Cable Woodchop',              tier:'A', sets:'3×12/side',desc:'تمرين تدوير مقاوم للكابل — يطور القوة الدورانية وال Obliques', vid:'db4_x6rpji8', vidPrevious:['yy3TRnJYE08', '8OZImYISmSg'], equipment:'gym', fatigue:'low', mu:'جانب البطن', category:'core_rotation'},
  ...
  mobility:[
    ...
    {n:'Thoracic Rotation (CARs)',    tier:'S', duration:'10 دورات/جانب', desc:'يحرر الظهر الوسط ويحسن وضعية الكتف — قبل تمارين الصدر والظهر', vid:'vMuOcANVE1o', vidPrevious:['4NnQeVkOjM'], equipment:'none', fatigue:'low', target:'ظهر وسط', category:'mobility_spine'},
  ...
  stretching:[
    ...
    {n:'Child\'s Pose Lower Back',   tier:'S', duration:'60ث × 2',       desc:'يمتد الظهر السفلي وال Lats — مريح جدا بعد تمارين الظهر', vid:'3uj8eL4hwTo', vidPrevious:['AgwjXQJqfYo'], equipment:'none', fatigue:'none', target:'ظهر سفلي ولاتس', category:'stretch_static'},
