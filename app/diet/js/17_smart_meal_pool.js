...
(function _v32_SmartMealPoolSystem() {
  ...
  function _pickFromDB(cat, slotKey, rng, exclude){
    ...
    function _riceAdj(f){
      ...
      // [FIX] الزبادي بدون حد أسبوعي — يظهر يومياً والحد اليومي 200 جرام فقط
      // تم حذف return 7 الذي كان يحد ظهور الزبادي أسبوعياً
      ...
      // [خبير تغذية] البسمتي أفضل من الأبيض: مؤشر جلايسيمي أقل (50-58 vs 64-72)
      if(id==='arzbsmtymtbwkh') return 10; // بسمتي أولوية أعلى
      if(id==='arzabydmtbwkh') return 7;   // أبيض أولوية أقل من البسمتي
